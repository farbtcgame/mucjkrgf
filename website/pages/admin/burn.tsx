          ...
          <div className="p-6 border border-zinc-800 bg-[#0f1115] space-y-4">
            ...
            {burnRewardsLoading ? (
              ...
              <div className="space-y-4">
                {burnRewards.map((r) => (
                  <div key={r.token} className="p-4 border border-zinc-800 bg-zinc-950 space-y-3">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                      ...
                      <div className="p-2 bg-black border border-zinc-900">
                        ...
                        <span className="text-xs text-[#CCFF00] font-bold">{r.availableCapacity.toString()} NFTs</span>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-2">
                      <input
                        ...
                        className="flex-1 bg-black border border-zinc-800 p-2 text-xs text-white focus:border-[#CCFF00] outline-none"
                      />
                      <button
                        onClick={() => submitUpdateAmount(r.token, r.decimals)}
                        disabled={!isBurnLabOwner}
                        className="px-4 py-2 bg-zinc-900 border border-zinc-700 text-white text-[10px] font-bold tracking-widest disabled:opacity-30"
                      >
                        UPDATE
                      </button>
                      <button
                    ...
                    <div className="flex flex-col sm:flex-row gap-2">
                      ...
                      <button
                        ...
                        disabled={!isBurnLabOwner}
                        className="px-4 py-2 bg-[#CCFF00] text-black text-[10px] font-bold tracking-widest disabled:opacity-30"
                      >
                        LOAD TOKENS
                      </button>
                    </div>
